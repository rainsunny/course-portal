...
import { getModuleContent, getAllModulePaths } from '@/lib/contentFiles';
...
export default function ModulePage({ params }: { params: { courseId: string; moduleId: string } }) {
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h1 className="text-xl font-bold">{currentModule?.title || '模块'}</h1>
                ...
                <div className="flex items-center space-x-2">
                  {prevModule && (
                    <Link
                      href={`/courses/${courseId}/module/${prevModule.id}`}
                  ...
                  {nextModule && (
                    <Link
                      href={`/courses/${courseId}/module/${nextModule.id}`}
  ...
  return (
    <Layout>
      <div className="bg-gray-50 min-h-screen">
        {/* Header */}
        <div className={`bg-gradient-to-br ${colors.gradient} text-white sticky top-16 z-40`}>
